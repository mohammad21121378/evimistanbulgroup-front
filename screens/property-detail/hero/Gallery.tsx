  ...
  return (
    <>
      <div className={styles.images}>
        ...
        <button className='bg-[#000000CF] hover:bg-black transition-all duration-500 absolute bottom-3 text-white font-medium text-sm right-3 rounded-2xl py-4 px-6 flex gap-1.5 items-center'
        onClick={() => {
          const el = document.getElementById("additional-media");
