    ...
    <section className={cn("section", styles.section)}>
      <div className={cn("container", styles.container)}>
        <div className={styles.content}>
          ...
          <div className="grid grid-cols-12 items-center mt-3.5">

            <PropertyFeatures
              features={item.features}
              className={`${styles.features} col-span-6`}
            />

            <div className="button col-span-4 button-red button-small">
              ALREADY SOLD
            </div>
          ...
          <div className="grid grid-cols-4 gap-2 mt-5 ">
            {
              ['Best for Investment', 'Best for Investment', 'Best for Investment', 'Best for Investment']
                .map(item =>
                  <div className="bg-[#002DD1] py-2 pl-3 rounded-md flex items-center text-white text-xs font-bold">
