            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, width: '35rem', height: '46rem', }}
                    ...
                    >
                        ...
                        <div className='bg-zinc-50'>
                            <div className="flex items-start justify-between  px-4 pt-4 pb-2.5 border-b bg-[linear-gradient(90deg,#ea580c_0%,#f97316_100%)]">
                        ...
                        <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 space-y-2 bg-zinc-50 pt-12 pb-3 scrollbar-sm" ref={messagesRef}>
