            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        <div className='pb-10  bg-[repeating-linear-gradient(to bottom, #f4f4f5 0px, #f4f4f5 1px, transparent 1px, transparent 24px)]'>
                            <div className="flex items-center justify-between  px-4 pt-4 pb-3.5 border-b bg-[linear-gradient(90deg,#ea580c_0%,#f97316_100%)]">
