...
export default function TemplateDesktop({ title, children, li = true, arrow = false }) {
    ...
    const content = (
        <>
            <span ref={titleRef} className={'cursor-pointer flex items-center gap-1'}>
                {title}
                {
                    arrow &&
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-down mt-1" viewBox="0 0 16 16">
