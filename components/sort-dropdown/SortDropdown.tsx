...
export default function SortDropdown({ value, onChange }: {
    ...
    return (
        <div className="relative md:inline-block block text-left z-10">
            ...
            {open && (
                <div className="absolute right-0 mt-2 md:w-48 w-full outline outline-1 outline-slate-200 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
